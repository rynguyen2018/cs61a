...
class Place(object):
    ...
    def __init__(self, name, exit=None):
        ...
        self.entrance=None
        if exit != None: 
            self.exit.entrance= self  # A Place
...
class ThrowerAnt(Ant):
    ...
    def __init__(self):
        super().__init__()
        self.min_range = 0 
        self.max_range = 9999999
        self.safe_zone= -5000 

    def nearest_bee(self, hive, count=0, safe_zone= 0,min_range=0, max_range=0):
        ...
        # BEGIN Problem 5
        "*** REPLACE THIS LINE ***" 
        if type(self)!=Place and type(self) != Hive and type(self) != Water and type(self) != QueenPlace: 
            argument= self.place
        ...
        if argument.name== "Hive" or count > max_range :
            return None
        if count< min_range or  random_or_none(argument.bees) is None or count==safe_zone: 
            return ThrowerAnt.nearest_bee(argument.entrance, hive, count+1, safe_zone,min_range, max_range)
        return random_or_none(argument.bees)
        # END Problem 5
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        "*** REPLACE THIS LINE ***"
        # END Problem 3
        super().add_insect(insect) #Place.add_insect(self, insect)
